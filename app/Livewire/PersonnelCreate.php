...
class PersonnelCreate extends Component
{
    ...
    public function save()
    {
        try {
            ...
            // Create initial service record only if school is assigned
            ...
            $this->dispatch('redirectToList', route('personnels.index'));
    ...
    private function switchToTabWithErrors($errors)
    {
        ...
        // Default to government tab if no specific errors found
