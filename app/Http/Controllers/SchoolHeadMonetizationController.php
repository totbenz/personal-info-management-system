...
class SchoolHeadMonetizationController extends Controller
{
    ...
    public function create()
    {
        ...
        // If no leave records exist, show a message
        if ($existingLeaves->isEmpty()) {
            return view('school_head.monetization.create', [
                'leaveBalances' => [],
                'message' => 'No leave records found for ' . $year . '. Please ask the administrator to process accruals first.'
            ]);
        }
