<div>
    ...
    <div class="flex gap-4 mb-6 p-3">
        ...
        <div class="max-w-xs">
            <select wire:model.live.debounce.300ms="selectedRole"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th wire:click="sortBy('personnel_id')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                        <div class="flex items-center space-x-1">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($accounts as $account)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $account->personnel?->personnel_id ?? '-' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $account->personnel?->fullName() ?? '-' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $account->email }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                ...
                                {{ $account->role == 'school_head' ? 'bg-green-100 text-green-800' : '' }}
                                {{ $account->role == 'teacher' ? 'bg-blue-100 text-blue-800' : '' }}
                                {{ $account->role == 'non_teaching' ? 'bg-gray-100 text-gray-800' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <button wire:click="openDeleteModal({{ $account->id }})"
                ...
                <form wire:submit="update">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Personnel Name</label>
                                <input type="text"
